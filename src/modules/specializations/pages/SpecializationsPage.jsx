...
import { normalizeSpecialization } from "@/lib/utils/normalizers";

export default function SpecializationsPage() {
  const { specializations, setSpecializations, loading } = useSpecializationsList();
  ...
  const handleSaved = (saved, isEdit) => {
    const norm = normalizeSpecialization(saved);
    if (isEdit) {
